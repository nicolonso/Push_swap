...
/*   Updated: 2025/08/21 20:12:58 by nalfonso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_stacks(t_stack_node **a, t_stack_node **b) //Define a function that sorts stack `a` if it has more than 3 nodes
{
	...
	len_a = stack_len(*a);
	if (len_a-- > 3 && !sorted_stack(*a)) //If stack `a` has more than three nodes and arent sorted
	pb(b, a, false);
	if (len_a-- > 3 && !sorted_stack(*a)) //If stack `a` still has more than three nodes and aren't sorted
	pb(b, a, false);
	while (len_a-- > 3 && !sorted_stack(*a)) //If stack `a` still has more than three nodes and aren't sorted
	{
